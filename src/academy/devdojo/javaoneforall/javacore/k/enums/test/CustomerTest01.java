...
public class CustomerTest01 {
  public static void main(String[] args) {
    Customer customer1 = new Customer("Jose", CustomerType.INDIVIDUAL);
    Customer customer2 = new Customer("Joao", CustomerType.COMPANY);
    Customer customer3 = new Customer("Joana", CustomerType.START_UP);
